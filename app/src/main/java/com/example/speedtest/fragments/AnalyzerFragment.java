...
public class AnalyzerFragment extends Fragment implements ItemTouchHelper {
    ...
    private void setDataChart(List<Wifi> wifiList) {
        ...
        binding.lcWifiChannel.getXAxis().setTextColor(getResources().getColor(android.R.color.white));
        binding.lcWifiChannel.getAxisLeft().setTextColor(getResources().getColor(android.R.color.white));
        binding.lcWifiChannel.getXAxis().setLabelCount(10, false);
        binding.lcWifiChannel.getLegend().setTextColor(getResources().getColor(android.R.color.white));
