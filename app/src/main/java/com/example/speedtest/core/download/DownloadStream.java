package com.example.speedtest.core.download;
...
public abstract class DownloadStream {
    ...
    public DownloadStream(String server, String path, int ckSize, String errorHandlingMode, int connectTimeout, int soTimeout, int recvBuffer, int sendBuffer){
        this.server=server;
        this.path=path;
        this.ckSize=ckSize;
